export const DISTRICTS_BY_STATE: Record<string, string[]> = {
  ...
  'Andhra Pradesh': [
    ...
    'Parvathipuram Manyam','Prakasam','Sri Balaji','Sri Potti Sriramulu Nellore',
  ...
  'Assam': [
    ...
    'Karbi Anglong','Karimganj (Sribhumi)','Kokrajhar','Lakhimpur','Majuli',
  ...
  'Punjab': [
    ...
    'Sahibzada Ajit Singh Nagar (Mohali)','Sangrur','Shaheed Bhagat Singh Nagar',
